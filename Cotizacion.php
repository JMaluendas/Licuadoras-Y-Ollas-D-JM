  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="btn btn-info" href="Cotizacion.php">Cotizar</a>
        </li>
      </ul>
    </div>
  </div>
...
<p>&nbsp;</p>
          <form id="form1" name="form1" method="post" action="">
            ...
            <table width="50%" border="4" align="center" bordercolor="#99FFFF">
              <tr>
                <th><input type="number" name="Cantidad" onfocus="this.select()" min="1" maxlength="3" required="required" class="form-control" size="35%" placeholder="Cantidad A Cotizar" /></th>
					<?php
